...
Revision ID: 02350604855c
Revises:
Create Date: 2026-06-09 09:37:16.763141
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("rental_type", sa.Enum("long_term", "short_term", name="rental_type_enum"), nullable=False),
        ...
        sa.Column("booking_source", sa.String(length=50), server_default=sa.text("'direct'"), nullable=False),
        sa.Column("status", sa.String(length=10), server_default=sa.text("'ACTIVE'"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "booking_source IN ('direct', 'airbnb', 'booking', 'agoda')", name="ck_contract_booking_source"
        ),
        sa.CheckConstraint("deposit IS NULL OR deposit > 0", name="ck_contract_deposit_positive"),
        sa.CheckConstraint("end_date IS NULL OR end_date > start_date", name="ck_contract_dates"),
        sa.CheckConstraint("rent_amount > 0", name="ck_contract_rent_positive"),
